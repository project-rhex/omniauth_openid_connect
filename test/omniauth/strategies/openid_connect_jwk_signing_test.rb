require 'test_helper'
class OpenIDConnectJwkSigningTest < Test::Unit::TestCase
  ...
  def strategy
    ...
    [OmniAuth::Strategies::OpenIDConnect,"localhost","my_id","my_s",{jwk_url: "/jwk", client_options:{scheme:"https", port:nil}}]
  end
  ...
  def test_callback
    ...
    stub_request(:get,'https://localhost/jwk').to_return( :body=>File.read("./test/fixtures/keys/jwk_pub.json"))
